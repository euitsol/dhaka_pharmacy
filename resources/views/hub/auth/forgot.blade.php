...
@section('title', 'Hub Staff Forgot Password')
@push('css')
                    ...
                    <div class="row row-gap-4">
                        <div class="col-lg-4 d-none d-lg-block">
                            <div class="image-col d-flex align-items-center justify-content-between">
                                <img src="{{ asset('admin/image/adminlogin.png') }}" alt="Staff Login Image">
                            </div>
                        </div>
                        <div class="col-lg-8 col-12">
                            <div class="form d-flex align-items-center justify-content-center h-100">
                                <div class="form-content w-100">
                                    ...
                                    <form action="{{ route('staff.forgot.send_otp') }}" method="POST">
                                        @csrf
                                        <div class="mb-4">
