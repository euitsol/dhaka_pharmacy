...
<section class="col-3 col-xxl-2 col-12 col-lg-3 sidebar-cat-section">
    <div class="col sticky-col pb-2 pb-lg-4">
        <div class="upload_prescription mb-2">
            <h2 class="text-center cat-title d-none d-lg-flex" data-bs-toggle="modal" data-bs-target="#prescriptionModal">
                <img class="icon" src="{{ asset('frontend/asset/icons/nav/upload-prescription.svg') }}" alt="Upload upload-prescription"> {{ __('Upload Prescription') }}
            </h2>
        </div>
