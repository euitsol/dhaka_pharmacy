                ...
                <div class="card-body py-3">
                    ...
                    <div class="row align-items-md-center align-items-start product_details mb-0 mb-md-2">
                        ...
                        <!-- <div class="col-8 col-md-6 info">
                            ...
                            <p class="m-0"><a href="" title="{{ $wish->product->pro_sub_cat->name }}" >{{ $wish->product->pro_sub_cat->name }}</a></p>
                            <p class="m-0"><a href="" title="{{ $wish->product->generic->name }}" >{{ $wish->product->generic->name }}</a></p>
                            <p class="m-0"><a href="" title="{{ $wish->product->company->name }}" >{{ $wish->product->company->name }}</a></p>
                        </div>
                        <div class="col-12 col-md-4 ps-3 ps-md-0">
                            <div class="details">
