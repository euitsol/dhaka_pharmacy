                                        ...
                                        <div class="col-7 col-xxl-6 col-12 col-md-7">
                                            <form action="{{ route('u.ck.single') }}" id="single_order_form"
                                                ...
                                                <div class="product_content">
                                                    <h1>{{ __($single_product->name . ' ' . optional($single_product->strength)->name) }}
                                                    </h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="related_product">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="title mb-3 mb-lg-4">{{ __('Medical Devices') }}</h2>
                            </div>
                            <div class="col-md-12">
                                <div id="bs-product-slider" class="owl-carousel">
