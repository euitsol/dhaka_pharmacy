                                ...
                                <div class="breadcrumb_wrap">
                                    <ul class="breadcrumb wizard">
                                        ...
                                        <li class="completed"><a
                                                href="{{ route('category.products', ['category' => $single_product->pro_cat->slug]) }}">{{
                                                __($single_product->pro_cat->name) }}</a>
                                        </li>
                                        @if ($single_product->pro_sub_cat)
                                        <li><a
                                                href="{{ route('category.products', ['category' => $single_product->pro_cat->slug, 'sub-category' => $single_product->pro_sub_cat->slug]) }}">{{
                                                __($single_product->pro_sub_cat->name) }}</a>
                                        </li>
                                        @endif
                                    </ul>
                                    <div class="favorite">
                                                ...
                                                <div class="tab-pane fade show active" id="info" role="tabpanel"
                                                    ...
                                                    <table class="table table-responsive table-bordered table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ __(optional($single_product->strength)->quantity . '
                                                                        ...
                                                                        <div class="testimonial">
                                                                            <div class="testimonial-content">
                                                                                ...
                                                                                <p class="description"
                                                                                    ...
                                                                                    {{
                                                                                    str_limit(html_entity_decode($review->description),
                                                                                    180) }}
                                                                                ...
                                                                                <p class="description text-end mt-2">
                                                                                    <strong>{{
                                                                                        optional($review->customer)->name
                                                                                        }}</strong>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                            ...
                            <div class="similar_products">
                                ...
                                <div class="products">
                                    <div class="row align-items-baseline px-0 ">
                                        ...
                                        @endphp
                                        <div class="col-xxl-12 col-md-4 col-sm-4 col-6 py-2 py-xxl-0 px-2 p-xxl-2">
                                            <div class="single-item">
                                                <div class="row align-items-center">
                                                    <div class="col-12 px-1 px-xxl-2 col-xxl-4 img">
                                                        <a class="d-block w-100"
                                                            href="{{ route('product.single_product', $product->slug) }}">
                                                            <img height="" class="w-100 border border-xxl-1 rounded-1"
                                                                src="{{ $product->image }}"
                                                                alt="{{ __($product->name) }}">
                                                        </a>
                                                    </div>
                                                    <div class="col-12 col-xxl-8 content px-2 px-lg-3 px-xxl-2">
                                                        ...
                                                        <p><a href="" title="{{ optional($product->generic)->name }}">
                                                                {{ optional($product->generic)->name }}
                                                            </a></p>
                                                        <p><a href="" title="{{ optional($product->company)->name }}">
                                        ...
                                        <div class="single-pdct">
                                            <a href="{{ route('product.single_product', $product->slug) }}">
                                                <div class="pdct-img">
                                                    ...
                                                    <span class="discount_tag">{{
                                                        formatPercentageNumber($product->discount_percentage) . '% off'
                                                        }}</span>
                                                    @endif
