                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="age"
                                                value="{{ dm()->age ? dm()->age : old('age') }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="identification_type" id="identification_type"
                                                ...
                                                <option value="NID"
                                                    {{ dm()->identification_type == 'NID' ? 'selected' : '' }}>
                                                    {{ __('National ID Card') }}</option>
                                                <option value="DOB"
                                                    {{ dm()->identification_type == 'DOB' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @if(!empty(dm()->cv))
                                        <a href="{{route('dm.profile.cv.download',base64_encode(dm()->cv))}}">
                    ...
                    <div class="profile_image">
                        <div class="img mx-auto mt-4">
                            <img class="avatar mb-0" id="previewImage"
                                src="{{(dm()->image)? (storage_url(dm()->image)) : 'https://white-dashboard-laravel.creative-tim.com/white/img/emilyz.jpg'}}" alt="">
