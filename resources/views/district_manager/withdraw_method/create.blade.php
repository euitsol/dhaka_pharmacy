    ...
    <div class="row">
        <div class="{{ $document ? 'col-md-8' : 'col-md-12' }} ">
            <div class="card ">
                ...
                <div class="card-body">
                    <form action="{{ route('dm.wm.create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>{{ __('Bank Name') }}</label>
                            <input type="text" name="bank_name"
                                class="form-control {{ $errors->has('bank_name') ? ' is-invalid' : '' }}"
                                placeholder="{{ __('Enter bank name') }}" value="{{ old('bank_name') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_brunch_name"
                                ...
                                placeholder="{{ __('Enter bank brunch name') }}" value="{{ old('bank_brunch_name') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="routing_number"
                                ...
                                placeholder="{{ __('Enter routing number') }}" value="{{ old('routing_number') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="account_name"
                                ...
                                placeholder="{{ __('Enter account name') }}" value="{{ old('account_name') }}">
