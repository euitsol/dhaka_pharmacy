...
@section('content')
    ...
    <section class="profile-section">
        <div class="container">
            <div class="row mb-4">
                <div class="col-12">
                    <ul class="nav nav-pills mb-3 p-title" id="pills-tab" role="tablist">
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mb-4 col-md-6">
                                                        ...
                                                        <input type="date" name="dob"
                                                            value="{{ $user->dob ?? old('dob') }}" class="form-control">
                                                ...
                                                <form class="updateForm" enctype="multipart/form-data">
                                                    ...
                                                    <div class="profile_image">
                                                        <div class="img mx-auto mt-4 rounded-circle">
                                                            <img class="avatar mb-0 rounded-circle w-100 h-100"
                                                                id="previewImage"
                                                                src="{{ auth_storage_url($user->image, $user->gender) }}"
                                                                alt="">
                                                            <label for="imageInput"
                                                                class="camera-icon text-center rounded-circle">
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-4 col-md-4">
                                                ...
                                                <input type="text" name="age"
                                                    value="{{ $user->age ?? old('age') }}" class="form-control"
                        ...
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                            ...
                            <div class="card">
                                <form method="POST" action="{{ route('u.profile.update.password') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group text-end">
                                            <button type="submit"
                                                class="submit_btn">{{ __('Change password') }}</button>
                                        </div>
                                    </div>
