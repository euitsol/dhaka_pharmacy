                        ...
                        <form action="{{ route('u.as.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 p-2">
                                    <label for="city" class="mb-1">{{ __('City') }} <small class="text-danger">*</small></label>
                                    <select name="city" id="city_select" class="form-control city_select"></select>
                                </div>
                                <div class="form-group col-md-6 p-2">
                                ...
                                <div class="form-group col-md-12 p-2">
                                    <button type="submit" class="btn btn-sm btn-success w-100 p-2">{{ __('Save') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
