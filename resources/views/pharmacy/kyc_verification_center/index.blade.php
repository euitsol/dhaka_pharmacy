    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" action="{{route('pharmacy.kyc.store')}}" autocomplete="off" enctype="multipart/form-data" disabled>
                            ...
                            @endphp
                                ...
                                @elseif($fd->type == "image")
                                    <div class="form-group {{ $errors->has($fd->field_key) ? ' has-danger' : '' }}">
                                        ...
                                        data-delete-url="{{route('pharmacy.kyc.file.delete', [$details->id, $a])}}"
                                        @endif
                                        >
                                        @include('alerts.feedback', ['field' => $fd->field_key])
                                    </div>
                                @elseif($fd->type == "image_multiple")
                                    ...
                                    @php
                                        ...
                                        foreach ($data as $index => $url) {
                                            $result .= route('pharmacy.kyc.file.delete', [$details->id, $a, base64_encode($url)]);
                                        ...
                                        <div class="show_file">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    @if(!$disabled)
                                                    <a href="{{route('pharmacy.kyc.file.delete', [$details->id, $a])}}">
                                            ...
                                            @foreach(json_decode($datas->submitted_data)->$a as $url)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        @if(!$disabled)
                                                        <a href="{{route('pharmacy.kyc.file.delete', [$details->id, $a, base64_encode($url)])}}">
                                                            <span class="input-group-text text-danger h-100"><i class="tim-icons icon-trash-simple"></i></span>
                                                        </a>
                                                        @endif
                                                    </div>
                ...
                xhr = $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.success) {
                            ...
                            let url = ("{{ route('pharmacy.kyc.file.delete', ['url']) }}");
