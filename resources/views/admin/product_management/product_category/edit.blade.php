            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"
                        ...
                        <div class="form-group">
                            <label>{{ _('Slug') }}</label>
                            <input type="text"  value="{{ $product_category->slug }}" class="form-control {{ $errors->has('slug') ? ' is-invalid' : '' }}" id="slug" name="slug" placeholder="{{ _('Enter Slug (must be use - on white speace)') }}">
