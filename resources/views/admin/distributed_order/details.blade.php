                    ...
                    <table class="table table-striped datatable">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $order->creater ? $order->creater->name : $order->customer->name }}</td>
                                                ...
                                                <div class="col-9">
                                                    <div class="media">
                                                        <div class="sq align-self-center "> <img
                                                                ...
                                                                src="{{ storage_url($dop->cart->product->image) }}"
                                                            ...
                                                            <div class="row  my-auto flex-column flex-md-row px-3">
                                                                <div class="col text-start">
                                                                    <h6 class="mb-0 text-start">
                                                                        {{ $dop->cart->product->name }}</h6>
                                                                    <small>{{ $dop->cart->product->pro_cat->name }}
                                                                    </small>
                                                                </div>
                                                                <div class="col-auto my-auto"> </div>
                                                                <div class="col my-auto"> <small>{{ __('Qty :') }}
                                                                        {{ $dop->cart->quantity }}</small></div>
