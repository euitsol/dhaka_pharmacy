            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @include('admin.order_management.includes.order_tracking', [
                                'order' => $do->order,
                            ])
                        </div>
                        <div class="col-md-12">
                            @if ($do->status != 0 && $do->status != 1)
                                ...
                                @if (auth()->user()->can('assign_order') && !$do->assignedRider->first())
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('om.order.assign_order', encrypt($do->id)) }}"
                                                method="POST">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <table class="table table-striped datatable">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td class="fw-bold">
                                                                    {{ $do->assignedRider->first()->rider->name }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td class="fw-bold">
                                                                    {{ $do->assignedRider->first()->rider->phone }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td class="fw-bold">
                                                                    {{ $do->assignedRider->first()->rider->age }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="fw-bold">{{ __('Delivery Priority') }}
                                                                </td>
                                                                <td>:</td>
                                                                <td class="fw-bold">
                                                                    {{ $do->assignedRider->first()->priority() }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="fw-bold">{{ __('Operational Area') }}
                                                                </td>
                                                                <td>:</td>
                                                                <td class="fw-bold">
                                                                    ...
                                                                    <div class="row  my-auto flex-column flex-md-row px-3">
                                                                        <div class="col text-start">
                                                                            <h6 class="mb-0 text-start">
                                                                                {{ $dop->order_product->product->name }}
                                                                            </h6>
                                                                        ...
                                                                        <div class="col my-auto">
                                                                            <small>{{ __('Qty :') }}
                                                                                {{ $dop->order_product->quantity }}</small>
                                                                        </div>
                                                                        <div class="col my-auto">
                                                                            <small>{{ __('Pack :') }}
