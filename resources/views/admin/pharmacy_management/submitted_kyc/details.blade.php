                                ...
                                @foreach ($form_datas as $key=>$form_data)
                                    ...
                                    @if($form_data['type'] == 'file_single')
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($save_datas[$form_data['field_key']]))
                                                    <a class="btn btn-info btn-sm" href="{{route('pm.pharmacy_kyc.kyc_list.download.pharmacy_kyc_details',base64_encode($save_datas[$form_data['field_key']]))}}"><i class="fa-regular fa-circle-down"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endif
                                            ...
                                            <td>
                                                @if(isset($save_datas[$form_data['field_key']]))
                                                    @foreach ($save_datas[$form_data['field_key']] as $file)
                                                        <a class="imagePreviewDiv btn btn-info btn-sm" href="{{route('pm.pharmacy_kyc.kyc_list.download.pharmacy_kyc_details',base64_encode($file))}}"><i class="fa-regular fa-circle-down"></i></a>
                                                    @endforeach
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="status_button">
                                            @if($data->status === 0)
                                                <a href="{{route('pm.pharmacy_kyc.kyc_list.accept.pharmacy_kyc_status',$data->id)}}" class="btn btn-sm btn-success">{{__('Accept')}}</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#updateDeclinedNote').click(function () {
                ...
                let id = $(this).data('id');
                let _url = ("{{ route('pm.pharmacy_kyc.kyc_list.declined.pharmacy_kyc_status', ['_id']) }}");
