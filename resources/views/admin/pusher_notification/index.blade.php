...
@section('content')
    ...
    <div class="row px-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ _('Notification Templates') }}</h5>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($notification_templates as $nt)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="status">
                                            <input type="checkbox" value="1" {{ $nt->status == 1 ? 'checked' : '' }} class="valueToggle status" name='status' data-toggle="toggle" data-onlabel="Active" data-offlabel="Deactive" data-onstyle="success" data-offstyle="danger" data-style="ios" data-id="{{$nt->id}}">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <a class="btn btn-info btn-sm text-white edit_nt"
                                            href="javascript:void(0)" data-id="{{$nt->id}}"><i
