            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="status_button text-end">
                        @if ($data->status === 0)
                            <a href="{{ route('dm_management.dm_kyc.kyc_list.accept.district_manager_kyc_status', $data->id) }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#updateDeclinedNote').click(function() {
                    ...
                    let id = $(this).data('id');
                    let _url = (
                        "{{ route('dm_management.dm_kyc.kyc_list.declined.district_manager_kyc_status', ['id']) }}"
                    );
