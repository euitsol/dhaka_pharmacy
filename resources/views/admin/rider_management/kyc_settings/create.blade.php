@extends('admin.layouts.master', ['pageSlug' => 'r_kyc_settings'])
@section('title', 'Rider KCY Setting')
@push('css_link')
        ...
        <div class="{{ $document ? 'col-md-8' : 'col-md-12' }}">
            <div class="card">
                <div class="card-header d-flex flex-row align-items-center justify-content-between">
                    <h5 class="title">{{ __('Rider KYC Setting') }}</h5>
                    <a href="javascript:void(0)" class="btn btn-primary btn-sm history">{{ __('KYC History') }}</a>
                </div>
            </div>
            <form method="POST" action="{{ route('rm.rider_kyc.settings.r_kyc_create') }}" autocomplete="off">
                @csrf
                <div class="card-body">
                    <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @include('admin.partials.action_buttons', [
                                            'menuItems' => [
                                                [
                                                    'routeName' => 'rm.rider_kyc.settings.r_kyc_details',
