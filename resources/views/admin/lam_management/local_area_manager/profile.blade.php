                ...
                <div class="card-body">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade  show active" id="details" role="tabpanel"
                            ...
                            @include('admin.lam_management.local_area_manager.includes.details')
                        </div>
                        <div class="tab-pane fade" id="earning" role="tabpanel" aria-labelledby="earning-tab">
                            @include('admin.lam_management.local_area_manager.includes.earning')
                        </div>
                        <div class="tab-pane fade" id="kyc" role="tabpanel" aria-labelledby="kyc-tab">
                            @include('admin.lam_management.local_area_manager.includes.kyc')
                        </div>
                        <div class="tab-pane fade" id="user" role="tabpanel" aria-labelledby="user-tab">
                            @include('admin.lam_management.local_area_manager.includes.users')
                        </div>
                    </div>
                </div>
            </div>
