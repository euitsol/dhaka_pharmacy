                                ...
                                @foreach ($form_datas as $key=>$form_data)
                                    ...
                                    @if($form_data['type'] == 'file_single')
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($save_datas[$form_data['field_key']]))
                                                    <a class="btn btn-info btn-sm" href="{{route('lam_management.lam_kyc.kyc_list.download.local_area_manager_kyc_details',base64_encode($save_datas[$form_data['field_key']]))}}"><i class="fa-regular fa-circle-down"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endif
                                            ...
                                            <td>
                                                @if(isset($save_datas[$form_data['field_key']]))
                                                    @foreach ($save_datas[$form_data['field_key']] as $file)
                                                        <a class="imagePreviewDiv btn btn-info btn-sm" href="{{route('lam_management.lam_kyc.kyc_list.download.local_area_manager_kyc_details',base64_encode($file))}}"><i class="fa-regular fa-circle-down"></i></a>
                                                    @endforeach
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#updateDeclinedNote').click(function () {
                ...
                let id = $(this).data('id');
                let _url = ("{{ route('lam_management.lam_kyc.kyc_list.declined.local_area_manager_kyc_status', ['id']) }}");
