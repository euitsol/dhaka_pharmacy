                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            @include('admin.partials.button', [
                                'routeName' => 'lam_management.lam_kyc.submitted_kyc.lams_kyc_list',
                ...
                <div class="card-footer">
                    <div class="status_button text-end">
                        @if ($submitted_kyc->status === 0)
                            <a href="{{ route('lam_management.lam_kyc.submitted_kyc.accept.lams_kyc_status', $submitted_kyc->id) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#updateDeclinedNote').click(function() {
                ...
                let id = $(this).data('id');
                let _url = (
                    "{{ route('lam_management.lam_kyc.submitted_kyc.declined.lams_kyc_status', ['_id']) }}"
                );
