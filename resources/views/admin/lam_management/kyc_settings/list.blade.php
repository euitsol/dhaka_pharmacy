            ...
            @forelse ($kycs as $group_kyc)
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="card-title">{{ __('Local Area Manager ' . $group_kyc[0]->getStatus() . ' KYC') }}
                                </h4>
                            </div>
                                            ...
                                            @else
                                                @include('admin.partials.action_buttons', [
                                                    'menuItems' => [
                                                        ...
                                                        [
                                                            'routeName' =>
                                                                'lam_management.lam_kyc.settings.lam_kyc_status',
                                                            'params' => [encrypt($kyc->id)],
            ...
            @empty
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="card-title">{{ __('Local Area Manager KYC Setting') }}</h4>
                            </div>
                            <div class="col-4 text-right">
                                @include('admin.partials.button', [
                                    'routeName' => 'lam_management.lam_kyc.settings.lam_kyc_create',
