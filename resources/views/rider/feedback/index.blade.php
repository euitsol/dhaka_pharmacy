@extends('rider.layouts.master', ['pageSlug' => 'feedback'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <form action="{{ route('rider.fdk.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('js')
    <script>
        file_upload(["#files"], "uploadfiles", "rider", true);
    </script>
@endpush
