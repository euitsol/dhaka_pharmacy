            ...
            <li>
                ...
                <div class="collapse @if (
                    ...
                    <ul class="nav pl-2">
                        ...
                        <li @if ($pageSlug == 'assigned_orders' || $pageSlug == 'picking-up_orders') class="active" @endif>
                            <a href="{{ route('rider.order_management.index', 'assigned') }}">
                                <i class="fa-solid fa-minus @if ($pageSlug == 'assigned_orders' || $pageSlug == 'picking-up_orders') fa-beat-fade @endif"></i>
                                <p>{{ 'Assigned Orders' }}</p>
                            </a>
                        </li>
                        <li @if ($pageSlug == 'picked-up_orders' || $pageSlug == 'delivered_orders') class="active" @endif>
                            <a href="{{ route('rider.order_management.index', 'picked-up') }}">
                                <i
                                    class="fa-solid fa-minus @if ($pageSlug == 'picked-up_orders' || $pageSlug == 'delivered_orders') fa-beat-fade @endif"></i>
