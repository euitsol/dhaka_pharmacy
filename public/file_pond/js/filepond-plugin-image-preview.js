...
(function (global, factory) {
    ...
    var createImageView = function createImageView(_) {
        return _.utils.createView({
            ...
            write: function write(_ref8) {
                ...
                var minPreviewHeight = root.query(
                    "GET_IMAGE_PREVIEW_MIN_HEIGHT"
                );
                var maxPreviewHeight = root.query(
    ...
    var createImageOverlayView = function createImageOverlayView(fpAPI) {
        return fpAPI.utils.createView({
            ...
            create: function create(_ref) {
                ...
                root.element.innerHTML = mask.replace(
                    /__UID__/g,
                    SVGMaskUniqueId
                );
            },
    ...
    var createImageWrapperView = function createImageWrapperView(_) {
        ...
        var didUpdateItemMetadata = function didUpdateItemMetadata(_ref4) {
            ...
            if (/crop|markup|resize/.test(action.change.key)) {
                ...
                if (
                    ...
                    Math.abs(crop.aspectRatio - image.crop.aspectRatio) >
                        0.00001
                ) {
         ...
         */
        var didCreatePreviewContainer = function didCreatePreviewContainer(
            _ref5
        ) {
            var root = _ref5.root,
                props = _ref5.props;
        ...
        var drawPreview = function drawPreview(_ref6) {
            ...
            var previewImageLoaded = function previewImageLoaded(imageData) {
                ...
                var pixelDensityFactor = Math.max(
                    1,
    ...
    var plugin = function plugin(fpAPI) {
        ...
        addFilter("CREATE_VIEW", function (viewAPI) {
            ...
            var rescaleItem = function rescaleItem(root, props) {
                ...
                var panelAspectRatio = root.query("GET_PANEL_ASPECT_RATIO");
                var itemPanelAspectRatio = root.query(
                ...
                if (
                    !isBitmap(item.file) ||
                    root.query("GET_IMAGE_PREVIEW_UPSCALE")
                ) {
                ...
                var previewAspectRatio =
                    (item.getMetadata("crop") || {}).aspectRatio ||
                    imageAspectRatio;
            ...
            var didCalculatePreviewSize = function didCalculatePreviewSize(
                _ref5
            ) {
                var root = _ref5.root,
                    action = _ref5.action;
