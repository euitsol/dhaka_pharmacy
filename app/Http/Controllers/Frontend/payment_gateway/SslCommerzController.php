...
class SslCommerzController extends Controller
{
    ...
    // {
    //     return view('ssl_commerz.exampleEasycheckout');
    // }
    ...
    public function index($order_id)
    {
        ...
        $post_data['cus_name'] = 'Md Shariful Islam';
        $post_data['cus_email'] = 'shariful@gmail.com';
        $post_data['cus_add1'] = 'Mirpur, Dhaka';
        $post_data['cus_add2'] = "Mirpur, Dhaka";//optional
        $post_data['cus_city'] = "Dhaka";//optional
        $post_data['cus_state'] = "Dhaka";//optional
        $post_data['cus_postcode'] = "1255";//optional
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = '01877018305';
