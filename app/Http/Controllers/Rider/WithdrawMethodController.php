...
class WithdrawMethodController extends Controller
{
    ...
    {
        $data['wms'] = WithdrawMethod::rider()->latest()->get();
        return view('rider.withdraw_method.list', $data);
    }
    ...
    public function create(): View
    {
        ...
        return view('rider.withdraw_method.create', $data);
    }
    public function store(WithdrawMethodRequest $request): RedirectResponse
    {
        WithdrawMethod::create(
            [
                ...
                'type' => $request->type,
                'creater_id' => rider()->id,
                'creater_type' => get_class(rider()),
            ]
        );
        flash()->addSuccess('Withdraw method created successfully.');
        return redirect()->route('rider.wm.list');
    }
}
